...
<span style="color: red; font-size:15px">Truco: Realizar el determinante de "A*" en función de "a", y así luego sólo debemos sutituir para cada valor (MÁS RÁPIDO)</span>
