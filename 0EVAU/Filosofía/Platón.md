...
___
Al igual que Pitágoras, Platón valora más el **conocimiento racional** que el sensible, y también defenderá el ==**dualismo antropomórfico**==: <span style="color: #0070c0;">El hombre es cuerpo, pero sobre todo alma, que al encarnarse en el cuerpo olvida las ideas.</span> Estas pueden ser **==recordadas==** a través de lo sensible (anamnesis).  <ul><li><span style="color: #0070c0;">Para poder llegar a las ideas, Platón propone el método de la <b>dialéctica:</b> que es un proceso ascendente en el que se parte de lo sensible para formar una opinión y tras esto, se pasa a lo inteligible </span></li></ul>
